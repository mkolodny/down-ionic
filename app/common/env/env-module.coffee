...
window.__meteor_runtime_config__ =
  DDP_DEFAULT_CONNECTION_URL: window.MeteorUrl or 'https://down-meteor.herokuapp.com'
...
window.__meteor_runtime_config__ =
  DDP_DEFAULT_CONNECTION_URL: window.MeteorUrl or 'https://down-meteor-staging.herokuapp.com'
...
### @if BUILD_ENV='local' ###
window.__meteor_runtime_config__ =
  DDP_DEFAULT_CONNECTION_URL: window.MeteorUrl or 'http://localhost:3500'
